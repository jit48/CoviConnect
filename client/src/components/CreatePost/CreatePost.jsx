...
const CreatePost = () => {
    ...
    return(
        <Fragment>
            <Button variant='primary' onClick={ModalHandler}>Create Post</Button>
            <Modal open={showModal}  handleModal={ModalHandler}>
                ...
                <Fragment>
                    ...
                    <br/>
                    <Button variant='secondary' onClick={ModalHandler}>Back</Button>
                </Fragment>
                ) : 
                    facility==="Beds" ? <Beds facilityHomeHandler={facilityHome}/> 
                    : facility === "Oxygen" ? <Oxygen facilityHomeHandler={facilityHome}/> 
                    : facility==="Ambulance" ? <Ambulance facilityHomeHandler={facilityHome}/> 
                    : facility==="Meals" ? <Meals facilityHomeHandler={facilityHome}/> 
                    : facility==="BloodBank" ? <BloodBank facilityHomeHandler={facilityHome}/> 
                    : facility==="DiagnosticCenter" ? <Diagnostic facilityHomeHandler={facilityHome}/> 
